...
- [Catalog 与远程 Engine 数据源测试](editor-testing/kyuubi.md)：Local/Kyuubi 共用的三段式 Catalog、ODEP、静态元数据和 `sparkone_mysql` provider，以及 Kyuubi 专属远程链路。
...
`SparkOneEngineContractTest.scala` 定义引擎无关的公共行为契约，Local 和 Kyuubi 各自的 fixture
