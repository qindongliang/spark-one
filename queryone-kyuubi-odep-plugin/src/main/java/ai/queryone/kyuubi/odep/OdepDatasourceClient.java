package ai.queryone.kyuubi.odep;
...
final class OdepDatasourceClient {
    ...
    private static final String API_URL_PROPERTY = "queryone.odep.api.url";
    private static final String APP_ID_PROPERTY = "queryone.odep.app.id";
    private static final String SIGN_KEY_PROPERTY = "queryone.odep.sign.key";
    private static final String CONNECT_TIMEOUT_PROPERTY =
            "queryone.odep.connect.timeout.seconds";
    private static final String REQUEST_TIMEOUT_PROPERTY =
            "queryone.odep.request.timeout.seconds";
